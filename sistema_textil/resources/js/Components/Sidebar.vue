<template>
    ...
    <div :class="[
      ...
      <nav class="flex-1 p-4">
        ...
        <inertia-link :href="('clients.index')" class="block py-2 px-4 hover:bg-gray-700 hover:text-slate-50 rounded-full mb-4">
          <i class="fas fa-users mr-2"></i>Clientes
        </inertia-link>
        <inertia-link :href="('orders.index')"
          class="block py-2 px-4 hover:bg-gray-700 hover:text-slate-50 rounded-full mb-4">
          <i class="fas fa-box mr-2"></i>Pedidos
        </inertia-link>
        <inertia-link :href="('products.index')"
          class="block py-2 px-4 hover:bg-gray-700 hover:text-slate-50 rounded-full mb-4">
          <i class="fas fa-shopping-cart mr-2"></i>Productos
        </inertia-link>
        <inertia-link :href="('categories.index')"
          class="block py-2 px-4 hover:bg-gray-700 hover:text-slate-50 rounded-full mb-4">
